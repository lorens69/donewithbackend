...
<style>
    ...
    <div class="d-flex flex-row-reverse" style="overflow: hidden;">
        ...
        <div class="container-fluid mt-2 p-5" style="width:90%;">
            ...
            <div class="card-body d-flex justify-content-left align-items-center  mt-4 p-5 row col-lg-12 ">
                <div class="card " style="background-color: #FFE6C7; max-width:fit-content  ">
                    ...
                    <button class="btn w-75 text-white p-2 fw-normal m-4 mt-0" style="background-color: #454545;">Call us
                        now! </button>
                </div>
    
                <div class="card " style="background-color: #FFE6C7; max-width:fit-content ">
                    <img src="./img/MobileInbox.png" width="100%" alt="" style="display: mt-5 ">
                    <button class="btn w-75 text-white p-2 fw-normal m-4 mt-0" style="background-color: #454545;">Book now!
                    </button>
                </div>
            </div>
