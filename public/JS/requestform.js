...
function validate(val) {
    ...
    v2 = document.getElementById("contact");
    v3 = document.getElementById("email");
    v4 = document.getElementById("address");
    v5 = document.getElementById("model");
    v6 = document.getElementById("yom");
    v7 = document.getElementById("service");
    v8 = document.getElementById("date");
    v9= document.getElementById("specialrequest");
